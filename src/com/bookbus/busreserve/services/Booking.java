...
public class Booking implements IBusReservationServices {
	...
	private static ArrayList<Helper> booked = new ArrayList<>(); 
	...
	public boolean is_available(Bus busChosenByUser) {
       ...
       if(count == 0 || count < busCount)
        ...
        {      
        	...
        	Passengers passengerDetails = new Helper().getPassengersDetails();
        	booked.add(new Helper(busChosenByUser,passengerDetails,dateString));
        }
